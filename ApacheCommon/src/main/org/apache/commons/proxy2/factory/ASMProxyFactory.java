package main.org.apache.commons.proxy2.factory;
...
import main.org.apache.commons.lang3.ObjectUtils;
import main.org.apache.commons.proxy2.*;
import main.org.apache.commons.proxy2.exception.ProxyFactoryException;
import main.org.apache.commons.proxy2.impl.AbstractProxyClassGenerator;
...
public class ASMProxyFactory extends AbstractProxyFactory {
    ...
    private static class ProxyGenerator extends AbstractProxyClassGenerator implements Opcodes {
        ...
        public Class<?> generateProxyClass(ClassLoader classLoader, Class<?>... proxyClasses) {
            final Class<?> supperClass = getSuperclass(proxyClasses);
            ...
            try {
                final byte[] proxyBytes = generateProxy(supperClass, classFileName, implementationMethods, interfaces);
         ...
         * @return
         */
        private static byte[] generateProxy(final Class<?> classToProxy, String proxyName, Method[] methods, Class<?>[] interfaces) {
        ...
        private static void init(final ClassWriter cw, final Type proxyType, Type superType) {
            final GeneratorAdapter adapter = new GeneratorAdapter(ACC_PUBLIC, new jdk.internal.org.objectweb.asm.commons.Method("<init>",
                    Type.VOID_TYPE, new Type[]{INVOKER_TYPE}), null, null, cw);
            //invoke super constructor;
            adapter.loadThis();
            adapter.invokeConstructor(superType, jdk.internal.org.objectweb.asm.commons.Method.getMethod("void <init> ()"));
        ...
        private static void processMethod(final ClassWriter cw, final Method method, final Type proxyType,
            ...
            final jdk.internal.org.objectweb.asm.commons.Method m = jdk.internal.org.objectweb.asm.commons.Method.getMethod(method);
            ...
            mg.invokeVirtual(classType, jdk.internal.org.objectweb.asm.commons.Method
            ...
            // invoke the invoker
            mg.invokeInterface(INVOKER_TYPE, jdk.internal.org.objectweb.asm.commons.Method
            ...
            if (exceptionTypes.length > 0)
            {
                ...
                mg.invokeVirtual(caughtExceptionType,
                        jdk.internal.org.objectweb.asm.commons.Method.getMethod("Throwable getCause()"));
                ...
                for (int i = 0; i < exceptionTypes.length; i++)
                {
                    ...
                    mg.invokeVirtual(classType,
                            jdk.internal.org.objectweb.asm.commons.Method.getMethod("boolean isInstance(Object)"));
                    // if true, throw cause:
                ...
                mg.dup();
                mg.loadLocal(cause);
                mg.invokeConstructor(undeclaredType, new jdk.internal.org.objectweb.asm.commons.Method("<init>", Type.VOID_TYPE,
