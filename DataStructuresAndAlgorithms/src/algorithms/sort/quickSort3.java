...
////////////////////////////////////////////////////////////////
class QuickArrayIns3 {
  private long[] theArray;          // ref to array theArray
  private int nElems;               // number of data items

  //--------------------------------------------------------------
  public QuickArrayIns3(int max)          // constructor
  {
...
//--------------------------------------------------------------
}  // end class QuickArrayIns3

////////////////////////////////////////////////////////////////
class QuickSort3App {
  public static void main(String[] args) {
    int maxSize = 16;             // array size
    QuickArrayIns3 arr;                 // reference to array
    arr = new QuickArrayIns3(maxSize);  // create the array
