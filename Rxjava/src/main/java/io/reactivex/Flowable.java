...
public abstract class Flowable<T> implements Publisher<T> {
   ...
   * </dl>
   *
   * @param supplier the Publisher javapattern.factory function to invoke for each {@link Subscriber} that subscribes to the
   *                 resulting Publisher
   ...
   * </dl>
   *
   * @param supplier a Callable javapattern.factory to return a Throwable for each individual Subscriber
   * @param <T>      the type of the items (ostensibly) emitted by the Publisher
   ...
   * @param resourceSupplier the javapattern.factory function to create a resource object that depends on the Publisher
   * @param sourceSupplier   the javapattern.factory function to create a Publisher
   ...
   * @param zipper     a function that, when applied to an item emitted by each of the source Publishers, results in
   *                   an item that will be emitted by the resulting Publisher
   * @param delayError delay errors signalled by any of the source Publisher until all Publishers terminate
   * @param bufferSize the number of elements to prefetch from each source Publisher
   * @return a Flowable that emits the zipped results
   * @see <a href="http://reactivex.io/documentation/operators/zip.html">ReactiveX operators documentation: Zip</a>
   */
   ...
   * @param mapper a function that, when applied to an item emitted by the source Publisher, returns an
   *               Publisher
   ...
   * </dl>
   *
   * @param onCancel the action that gets called when the source {@code Publisher}'s Subscription is cancelled
   ...
   * @return a {@link Disposable} that allows cancelling an asynchronous sequence
   * @throws NullPointerException if {@code onNext} is null
   * @see <a href="http://reactivex.io/documentation/operators/subscribe.html">ReactiveX operators documentation: Subscribe</a>
   */
  @CheckReturnValue
   ...
   * @param time       the length of the time window
   * @param unit       the time unit of {@code time}
   * @param delayError if true, an exception signalled by the current Flowable is delayed until the regular elements are consumed
