...
public abstract class Maybe<T> implements MaybeSource<T> {
   ...
   * </dl>
   *
   * @param supplier a Callable javapattern.factory to return a Throwable for each individual MaybeObserver
   ...
   * </dl>
   *
   * @param callable function which execution should be deferred, it will be invoked when MaybeObserver will subscribe to the {@link Maybe}.
   ...
   * @param resourceSupplier the javapattern.factory function to create a resource object that depends on the Maybe
   * @param sourceSupplier   the javapattern.factory function to create a MaybeSource
   ...
   *
   * @param <R>    the result value type
   * @param mapper a function that, when applied to the item emitted by the source Maybe, returns an
   *               Flowable
   ...
   * @param lift the MaybeOperator that implements the Maybe-operating function to be applied to the source Maybe
   ...
   * </dl>
   *
   * @param next the next Maybe source that will take over if the source Maybe encounters
   *             an error
   * @return the new Maybe instance
   ...
   * </dl>
   *
   * @param valueSupplier a function that returns a javapattern.single value that will be emitted as success value
