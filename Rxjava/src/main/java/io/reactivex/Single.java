...
public abstract class Single<T> implements SingleSource<T> {
   ...
   *
   * @param <T>     the common value type
   * @param source1 a Single to be merged
   * @param source2 a Single to be merged
   ...
   * @param source1 a Single to be merged
   * @param source2 a Single to be merged
   * @param source3 a Single to be merged
   * @return a Flowable that emits all of the items emitted by the source Singles
   * @see <a href="http://reactivex.io/documentation/operators/merge.html">ReactiveX operators documentation: Merge</a>
   */
  @CheckReturnValue
   ...
   * @param source2 a Single to be merged
   * @param source3 a Single to be merged
   * @param source4 a Single to be merged
   * @return a Flowable that emits all of the items emitted by the source Singles
   * @see <a href="http://reactivex.io/documentation/operators/merge.html">ReactiveX operators documentation: Merge</a>
   */
  @CheckReturnValue
   ...
   *
   * @param <R>    the result value type
   * @param mapper a function that, when applied to the item emitted by the source Single, returns an
   *               Flowable
   ...
   * </dl>
   *
   * @param other a Single to be merged
