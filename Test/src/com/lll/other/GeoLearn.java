...
//    f = 1.0 / 298.3;
  ...
  public static void main(String[] args) {
    double lat = 31.2395800000;
    double log = 121.4997630000;

    System.out.println("x===" + gaussBLtoXY(lat, log)[0]);
    System.out.println("y===" + gaussBLtoXY(lat, log)[1]);
  }
}
