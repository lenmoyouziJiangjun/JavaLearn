...
/**
 * Created by huangmin on 15/12/7.
 */
public class CharacterParser {
     ...
     * @return
     */
    public char getFirstChar(String chs) {
        String pinyin = getSpelling(chs);
     ...
     * @return
     */
    public String getFirstString(String chs) {
        String pinyin = getSpelling(chs);
        String firstLetter = pinyin.substring(0, 1);

//        if (StringUtil.isCharacter(firstLetter)) {
//            return firstLetter;
//        } else {
//            return "#";
//        }
