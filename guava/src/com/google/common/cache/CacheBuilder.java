...
public class CacheBuilder<K, V> {
  ...
  long expireAfterWriteNanos = UNSET_INT; // should be a java.time.Duration

  @SuppressWarnings("GoodTime")
  long expireAfterAccessNanos = UNSET_INT; // should be a java.time.Duration

  @SuppressWarnings("GoodTime")
  long refreshNanos = UNSET_INT; // should be a java.time.Duration
